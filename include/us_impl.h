...
#define STYLE_CMD(name)                           \
    ANSI_BOLD "|" ANSI_COLOR_CYAN STR_VALUE(name) \
    ANSI_COLOR_RESET ANSI_BOLD "|" ANSI_COLOR_RESET
...
_Return_type_success_(return == USReturnNormal) ENUM(USReturn, byte,
	Normal,
	Cancel,
	Exit
);
...
_Ret_maybenull_ User* us_create_user_h(
